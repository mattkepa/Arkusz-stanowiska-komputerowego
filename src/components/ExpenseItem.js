...
function ExpenseItem(props) {
  ...
  return (
    <tr className="datatable__row">
      ...
      <td className="datatable__cell datatable__cell--name">{data.name}</td>
      <td className="datatable__cell datatable__cell--info">{data.details}</td>
      <td className="datatable__cell datatable__cell--category">
        {data.category}
      </td>
      <td className="datatable__cell datatable__cell--price">
      ...
      <td className="datatable__cell datatable__cell--actions">
        <button type="button" className="btn btn--small btn--red">
          ...
          <span className="button-text">Usuń</span>
        </button>
      </td>
    </tr>
  );
